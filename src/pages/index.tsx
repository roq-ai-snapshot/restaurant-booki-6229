  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the convenience with Restaurant Booking Engine - Your ultimate platform for seamless table reservations and efficient restaurant management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the convenience with Restaurant Booking Engine - Your ultimate platform for seamless table reservations and efficient restaurant management.`}
            </Text>
            <Box
